...
function Hero() {
  return (
    <div className="    ">
    <nav className="   bg-slate-50   flex items-center justify-center  ">
     <div className="container  px-16   mx-auto grid py-48   gap-10  w-full grid-cols-1 items-center lg:grid-cols-2">
        <motion.div 
